<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('name', $data['name'], ['class' => 'form-control','placeholder'=>'Enter the name of the Portfolio']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('filter', $data['filter'], ['class' => 'form-control','placeholder'=>'Enter the filter of the Portfolio']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::file('images', ['class' => 'filestyle','data-buttonText'=>'Coose image','data-buttonName'=>"btn-primary",'data-placeholder'=>"No file"]) !!}
        </div>
    </div>
