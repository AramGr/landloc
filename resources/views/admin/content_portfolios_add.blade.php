<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'enter the name of the portfolio']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('filter', old('filter'), ['class' => 'form-control','placeholder'=>'enter the filter of the portfolio']) !!}
        </div>
    </div>
